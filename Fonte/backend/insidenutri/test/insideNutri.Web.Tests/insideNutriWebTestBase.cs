...
{
    public abstract class insideNutriWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static insideNutriWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(insideNutriWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<insideNutriDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<insideNutriDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<insideNutriDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<insideNutriDbContext, Task<T>> func)
        {
            T result;
